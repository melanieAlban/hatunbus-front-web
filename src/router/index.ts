...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'drivers', name: 'AdminDrivers', component: () => import('../modules/conductores/views/DriversView.vue'), meta: { requiresAuth: true, roles: ['COOPERATIVE'] } },
      { path: 'buses', name: 'AdminBuses', component: () => import('../modules/admin/views/BusesView.vue'), meta: { requiresAuth: true, roles: ['COOPERATIVE'] } },
